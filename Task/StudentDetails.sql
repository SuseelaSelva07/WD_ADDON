...
+-----------+--------+---------------------+----------+
| Keerthana | 232622 | keerthana@gmail.com | 21346587 |
+-----------+--------+---------------------+----------+
1 row in set (0.00 sec)

mysql> insert into student values('Harini',232614,'Harini@gmail.com',21345687);
Query OK, 1 row affected (0.01 sec)

mysql> insert into student values('vaishu',232656,'Vaishu@gmail.com',987654332);
Query OK, 1 row affected (0.01 sec)

mysql> insert into student values('Rubi',232642,'Rubi@gmail.com',987676547);
Query OK, 1 row affected (0.01 sec)

mysql> insert into student values('Uma',232642,'Uma@gmail.com',965390636);
Query OK, 1 row affected (0.01 sec)
...
+-----------+--------+---------------------+-----------+
| Keerthana | 232622 | keerthana@gmail.com |  21346587 |
| Harini    | 232614 | Harini@gmail.com    |  21345687 |
| vaishu    | 232656 | Vaishu@gmail.com    | 987654332 |
| Rubi      | 232642 | Rubi@gmail.com      | 987676547 |
| Uma       | 232642 | Uma@gmail.com       | 965390636 |
+-----------+--------+---------------------+-----------+
5 rows in set (0.00 sec)
