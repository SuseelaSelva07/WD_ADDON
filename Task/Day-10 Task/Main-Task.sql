...
mysql> insert into customer values(2,'priya','priya@gmail.com',987654321,'coimbatore','2001-02-01','inactive');
Query OK, 1 row affected (0.01 sec)

mysql> insert into customer values(3,'Aishu','aishu@gmail.com',9437473221,'coimbatore','2002-03-02','active');
Query OK, 1 row affected (0.01 sec)
